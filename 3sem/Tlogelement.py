...
#
#     def calc(self):
#         self.notA.In1 = self.In1
#         self.notB.In1 = self.In2
#
#         self.notA.calc()
#         self.notB.calc()
#
#         self.and1.In1 = self.In1
#         self.and1.In2 = self.notB.Res
#         self.and1.calc()
#
#         self.and2.In1 = self.notA.Res
#         self.and2.In2 = self.In2
#         self.and2.calc()
#
#         self.or1.In1 = self.and1.Res
#         self.or1.In2 = self.and2.Res
#         self.or1.calc()
#
#         self._res = self.or1.Res
